...
export default function RequestForm({ onSubmit }: RequestFormProps) {
  ...
  return (
    <div className="relative min-h-screen py-12 px-4 sm:px-6 lg:px-8" style={{
      ...
      <motion.div
        className="relative bg-white/70 backdrop-blur-md shadow-2xl rounded-2xl p-8 sm:p-10 max-w-4xl mx-auto border-0"
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="pt-4">
            <motion.button
              type="submit"
              className={`w-full flex justify-center py-4 px-6 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-[#00b67f] hover:bg-[#00996d] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#00b67f] transition-colors duration-200 ${
